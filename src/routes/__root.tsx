...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "초등학교 체육수업과 반 대항전을 위한 배드민턴 리그 & 티어 랭킹 앱." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "초등 배드민턴 리그 · 티어 시스템" },
      { property: "og:description", content: "초등학교 체육수업과 반 대항전을 위한 배드민턴 리그 & 티어 랭킹 앱." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "초등 배드민턴 리그 · 티어 시스템" },
      { name: "twitter:description", content: "초등학교 체육수업과 반 대항전을 위한 배드민턴 리그 & 티어 랭킹 앱." },
